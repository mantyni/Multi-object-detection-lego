...
# Label map
labels = ('brick_2x2', 'brick_2x4', 'brick_1x6', 'plate_1x2', 'plate_2x2', 'plate_2x4')
...
def create_data_lists(train_path, test_path, output_folder):
    ...
    :param train_path: path to the 'data/Train' folder
    :param test_path: path to the 'data/Test' folder
    ...
    # Training data
    for path in [train_path]: # rename train dataset
    ...
    # Find IDs of images in the test data # RENAME
